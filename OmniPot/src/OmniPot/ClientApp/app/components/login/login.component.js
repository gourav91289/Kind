        ...
        execute: function () {
            LoginComponent = (function () {
                ...
                LoginComponent.prototype.subcribeToFormChanges = function () {
                    var _this = this;
                    var formStatusChanges = this.loginForm.statusChanges;
                    var formValueChanges = this.loginForm.valueChanges;
                    formStatusChanges.subscribe(function (x) { return _this.events.push({ event: 'STATUS_CHANGED', object: x }); });
                    formValueChanges.subscribe(function (x) { return _this.events.push({ event: 'VALUE_CHANGED', object: x }); });
                };
