System.register(["@angular/core", "@angular/forms", "@angular/platform-browser", "@angular/router", "@angular/http", "../../viewmodels/account/login", "../../services/validation.service", "../../security/auth.service"], function (exports_1, context_1) {
    "use strict";
    ...
    var core_1, forms_1, platform_browser_1, router_1, http_1, login_1, validation_service_1, auth_service_1, LoginComponent;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            LoginComponent = (function () {
                ...
                LoginComponent.prototype.ngOnInit = function () {
                    this.loginViewModel = new login_1.LoginViewModel();
                };
