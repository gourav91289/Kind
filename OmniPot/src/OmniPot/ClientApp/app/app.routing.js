System.register(["@angular/router", "./security/auth-guard.service", "./components/login/login.component", "./components/dashboard/dashboard.component", "./components/login/registration.component", "./components/token.verify.component"], function (exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var router_1, auth_guard_service_1, login_component_1, dashboard_component_1, registration_component_1, token_verify_component_1, routes, AppRoutingProviders, AppRouting;
    return {
        setters: [
            function (router_1_1) {
                router_1 = router_1_1;
